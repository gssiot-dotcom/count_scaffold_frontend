// src/roles/officeManager/RoleAssignment.jsx
// 사무실 직원 승인 + 현장 배정 관리
...
export default function OfficeRoleAssignment() {
          ...
          <table className="w-full border-collapse">
            ...
            <tbody>
              {loading ? (
                ...
                <tr>
                  <td colSpan={7} className="px-5 py-12 text-center text-[1.125rem] text-slate-500">
                    {tab === "pending" ? "승인 대기 중인 직원이 없습니다." : "등록된 직원이 없습니다."}
                  </td>
                </tr>
              ) : (
